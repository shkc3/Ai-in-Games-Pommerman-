...
public class Parametersshkc implements ParameterSet {
    ...
    public final int CUSTOM_HEURISTIC = 1;
    public final int ADVANCED_HEURISTIC = 0;
    public final int HEURISTICSshkc = 2;

    public double epsilon = 1e-6;
//    public double decayEpsilon = 1e-6;
  //  public int factor = 1;
 ...
 // public int heuristic_method = HEURISTICSshkc;
    ...
    public double AMAPAplha = 0.25;
    public boolean AMAFPolicyEnable = false;
    public String policyType="uct";
    ...
    public void setParameterValue(String param, Object value) {
        switch(param) {
            ...
            case "policyType": policyType = (String) value; break;
            case "AMAFPolicyEnable": AMAFPolicyEnable = (boolean) value; break;
        }
    }
    ...
    public Object getParameterValue(String param) {
        switch(param) {
            ...
            case "AMAFPolicyEnable": return AMAFPolicyEnable;
        }
        return null;
    }
    ...
    public ArrayList<String> getParameters() {
        ...
        paramList.add("policyType");
        paramList.add("AMAFPolicyEnable");
        return paramList;
    }
    ...
    public Map<String, Object[]> getParameterValues() {
        ...
        parameterValues.put("heuristic_method", new Integer[]{CUSTOM_HEURISTIC, ADVANCED_HEURISTIC,HEURISTICSshkc});
        parameterValues.put("policyType",new String[]{"uct","uct2Tuned","uctBayesian","AMAF","alphaAMAF"});//tree policies
        parameterValues.put("AMAFPolicyEnable",new Boolean[]{true,false});
    ...
    public Map<String, String[]> constantNames() {
        ...
        names.put("heuristic_method", new String[]{"CUSTOM_HEURISTIC", "ADVANCED_HEURISTIC","HEURISTICSshkc"});
        return names;
    }
}
